...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate__ = __webpack_require__(38);
...
var showData = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#showData',
    data: {
        message: 'Hello Vue!',
        salaryInfo: []
            ...
            this.$validator.validateAll().then(function (success) {
                if (!success) {
                    ...
                    axios.post('/salaryInfo/add', {
                        info_name: _this2.info_name,
                        info_status: _this2.info_status,
                        info_amount: _this2.info_amount
